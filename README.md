...
```bash
$ git clone https://github.com/sangramapancasadewa/AlisaBot
$ cd AlisaBot
$ npm install
$ node index.js
```
...
## Donate
<a href="https://saweria.co/sangramapanca" target="_blank"><img src="https://user-images.githubusercontent.com/26188697/180601310-e82c63e4-412b-4c36-b7b5-7ba713c80380.png" alt="Donate For Yusril" height="41" width="174"></a>

## License
[MIT License](https://github.com/sangramapancasadewa/AlisaBot/blob/main/LICENSE)
